...
const successapi = async (res, message, status = constants.META_STATUS.DATA, statusCode = constants.WEB_STATUS_CODE.SERVER_ERROR, data = null, extras = null, dynamicMessage = '') => {
	try {
		const response = {
			meta: {
				status,
